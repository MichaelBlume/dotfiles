...
syn match debsourcesDistrKeyword   +\([[:alnum:]_./]*\)\(woody\|sarge\|etch\|old-stable\|stable\|testing\|unstable\|sid\|experimental\|warty\|hoary\|breezy\|dapper\|edgy\|feisty\|gutsy\|hardy\|-proposed\|-updates\|-security\|-backports\|-commercial\|-partner\)\([[:alnum:]_./]*\)+
